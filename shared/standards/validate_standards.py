...
def validate_standards():
    ...
    try:
        ...
        try:
            ...
            print("✓ Valid: scoring.yaml (+ azure_scoring.yaml overlay)")
        ...
        if errors:
            ...
            for error in errors:
                print(f"  {error}")
            print("\nEXPECTED YAML FILES:")
            print("  - config/scoring.yaml (cloud-agnostic base scoring standards)")
            print("  - config/implementation_standards.yaml (implementation costs and thresholds)")
            print("  - config/azure_scoring.yaml (optional Azure overlay)")
            return False
        else:
        ...
        print("  - config/scoring.yaml")
        print("  - config/implementation_standards.yaml")
        return False
...
def validate_no_hardcoded_fallbacks():
    ...
    try:
        ...
        if cpu_targets['target_min'] == 60.0 and cpu_targets['target_max'] == 80.0:
            ...
            print(f"Warning: Unexpected values: {cpu_targets}")
