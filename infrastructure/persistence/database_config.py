...
class DatabaseConfig:
    ...
    # Use volume mount path if available, otherwise require explicit configuration
    ...
    if volume_mount:
        ...
        if not _base_dir:
            raise ValueError("No volume detected. DATABASE_BASE_DIR environment variable is REQUIRED.")
