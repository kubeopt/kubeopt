...
def migrate_database_schema(db_path: str = 'infrastructure/persistence/database/clusters.db'):
...
def migrate_analysis_data_to_blob(db_path: str = 'infrastructure/persistence/database/clusters.db'):
...
def migrate_database_for_multi_subscription(db_path: str = 'infrastructure/persistence/database/clusters.db'):
